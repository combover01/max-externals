...
/// Requires: me is valid and created by circular_buf_init
void circular_buf_put(cbuf_handle_t me, double data);
...
int circular_buf_try_put(cbuf_handle_t me, double data);

/// Retrieve a value from the buffer
/// Requires: me is valid and created by circular_buf_init
/// Returns 0 on success, -1 if the buffer is empty
int circular_buf_get(cbuf_handle_t me, double* data);
...
int circular_buf_peek(cbuf_handle_t me, double* data, unsigned int look_ahead_counter);
